...
public class PointClickPlacementTool : EditorWindow
{
	...
	private void AddSingle(Vector3 buildPos, RaycastHit clickedObject)
	{
        ...
        if(randomRotate) {
            prefab.transform.RotateAround(prefab.transform.position, prefab.transform.up, Random.Range(0, 360));
        }
	...
	void OnGUI()
	{
        ...
        randomRotate = EditorGUILayout.Toggle("Random Rotation", randomRotate);
